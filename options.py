...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--n_epochs', type=int, default=1000, help='Número total de épocas')
        parser.add_argument('--n_epochs_decay', type=int, default=500, help='Número de épocas para decaimento linear da taxa de aprendizado')
